...
```bash
bash <(curl -s https://raw.githubusercontent.com/jinmo-yi/amelabs/refs/heads/main/azmon-lab-agents-essentials/init-lab.sh)
```

### Lab 2: AMPLS & Application Insights Lab  
```bash
bash <(curl -s https://raw.githubusercontent.com/jinmo-yi/amelabs/refs/heads/main/azmon-lab-ampls-appinsights/init-lab.sh)
```
